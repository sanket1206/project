...
<body>
 ...
 @auth
           ...
           <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" method="POST" href="{{url('logout')}}" style="background-color:blue">logout</a>
            </li>
 ...
 <div align="center"  style="padding:70px;">
    ...
    <tr style="background-color:black;">
        ...
        <th style="padding:10px; font-size:20px; color:white">Measage</th>
    ...
    <tr style="background-color:black;" align="center">
        ...
        <td>
            <a class="bt btn-danger" onclick="return confirm('are you sure to delete this')" href="{{url('cancle_appoint',$appoints->id)}}">Cancle</a>
        </td>
    </tr>
    @endforeach
    </table>
